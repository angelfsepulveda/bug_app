...
def create_ticket(request):
    context={}
    context['app']                   = 'create_ticket'
    context['app_name']              = 'create_ticket'
    context['seccion']               = '%s_inicio_create_ticket' % (context['app'])
    context['navbar']                = True
    context['menu']                  = True
    context['footer']                = False
    context['user_id']               = request.user.id
    context['sidebar']               = False
    context['titulo']                = '%s: create_ticket'
    ...
    return render(request, 'bug_app/templates/create_ticket.html', context)