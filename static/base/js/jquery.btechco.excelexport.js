...
(function ($) {
    ...
    $.fn.btechco_excelexport = function (options) {
        ...
        function Export(htmltable) {
            ...
            var documento         = stob(excelFile,{type:'data:application/vnd.ms-excel;charset=utf-8;filename='+filename+';'});
            var uri               = URL.createObjectURL(documento);
...
function stob(string, contentType, sliceSize){
  contentType = contentType || '';
  sliceSize = sliceSize || 512;
  var byteCharacters = string;
  var byteArrays = [];
